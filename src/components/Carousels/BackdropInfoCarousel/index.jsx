...
import "./styles.css";
import BackdropItem from "./components/BackdropInfoItem";
import BackdropInfoItem from "./components/BackdropInfoItem";

const BackdropInfoCarousel = ({ movies = [] }) => {
  ...
  return (
    <section>
      <div className="backdrop-container">
        <button
          className="backdropinfo-PrevBtn"
          onClick={scrollPrev}
        ...
        >
          {movies.map((movie, index) => (
            <BackdropInfoItem
              key={index}
              movie={movie}
              className="backdropinfo-item"
            />
          ))}
        </div>

        <button
          className="backdropinfo-NextBtn"
          onClick={scrollNext}
          disabled={
...
export default React.memo(BackdropInfoCarousel);
