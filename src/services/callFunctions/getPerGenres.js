...
export const getPerGenres = (SectionData) => {
    const { mediaType, movieId, language, selectedGenre, filterMode, filterScope, sortBy, pageNumber } = SectionData;
...
${api_path}3/trending/${filterScope}/${timeWindow}?${rawLanguage}${rawApiKey}&page=${pageNumber}`;
