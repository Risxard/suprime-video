...
export const homeSections = (language) => {
  return [
    {
      id: "hero",
      carousels: [
...

    {
      ...
      carousels: [
        ...
        },
        {
          ...
          fetchParams: { mediaType: "movie", mediaId: 845781, language },
        },
        ...
        },
        {
          ...
          card_size: "ss-card",
          fetchFn: tmdbService.fetchList,
          fetchParams: { list_id: 8568116, language, page: 1 },
        },
        {
        ...
        },
        {
          ...
          skeleton: HeroSectionSkeleton,
          fetchFn: tmdbService.fetchMediaDetails,
          fetchParams: { mediaType: "movie", mediaId: 617126, language },
        },
        {
