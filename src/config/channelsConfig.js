      ...
      },
      {
        carousels: [
          ...
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567846, language: i18n.language, page: 1 },
          },
          {
        ...
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567899, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567890, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 24035, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567704, language: i18n.language, page: 1 },
          },
          {
            ...
            fetchParams: { collection_id: 91657, language: i18n.language, page: 1 },
          },
        ],
      },
    ],
    ...
    sections: [
      {
        carousels: [
          ...
          },
          {
            ...
            fetchParams: { mediaType: "movie", mediaId: 1022787, language: i18n.language },
          },
        ],
      },
      {
        carousels: [
          ...
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568113, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567971, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567975, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8567969, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568111, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568107, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568128, language: i18n.language, page: 1 },
          },
        ],
      },
    ],
        ...
        carousels: [
          {
            ...
            skeleton: HeroSectionSkeleton,
            fetchFn: tmdbService.fetchMediaDetails,
            fetchParams: { mediaType: "tv", mediaId: 138505, language: i18n.language },
          },
          {
          ...
          },
          {
            ...
            card_size: "sm-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568154, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568155, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568157, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568159, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568166, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568171, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568331, language: i18n.language, page: 1 },
          },
        ],
      },
    ],
        ...
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568180, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568181, language: i18n.language, page: 1 },
          },
          {
            type: "hero-section",
            component: HeroSection,
            skeleton: HeroSectionSkeleton,
            fetchFn: tmdbService.fetchMediaDetails,
            fetchParams: { mediaType: "tv", mediaId: 114479, language: i18n.language },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568187, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568193, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568190, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568743, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568738, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568742, language: i18n.language, page: 1 },
          },
        ],
      },
    ],
        ...
        carousels: [
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568750, language: i18n.language, page: 1 },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568753, language: i18n.language, page: 1 },
          },
        ],
      },
      {
        carousels: [
          {
            ...
            skeleton: HeroSectionSkeleton,
            fetchFn: tmdbService.fetchMediaDetails,
            fetchParams: { mediaType: "movie", mediaId: 1537366, language: i18n.language },
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568758, language: i18n.language, page: 1 },
          },
          {
            title: i18n.t("sections.national.originals"),
            type: "grand-poster",
          ...
          },
          {
            ...
            card_size: "ss-card",
            fetchFn: tmdbService.fetchList,
            fetchParams: { list_id: 8568759, language: i18n.language, page: 1 },
          },
        ],
      },
    ],
